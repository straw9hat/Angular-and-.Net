...
namespace WebApplication11.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int prcInsertCommand(string pname, Nullable<int> cid, Nullable<decimal> price)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("prcInsertCommand", pnameParameter, cidParameter, priceParameter);
        }
